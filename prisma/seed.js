...
Email: book@opalchauffeurs.com.au | Direct: +61 432 000 718`,
    ...
    // item counts. Real values only ever come from an actual job execution
    // (see /api/jobs POST). On re-seed, only structural fields (title,
    // frequency, isEnabled) are touched — real accumulated run history is
    // never overwritten back to these placeholders.
